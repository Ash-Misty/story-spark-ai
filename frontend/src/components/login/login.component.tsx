      ...
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10 box-border">
        ...
        <div className="flex justify-center w-full box-border">
          <motion.div
            ...
            className="w-full max-w-md min-w-0 overflow-hidden bg-slate-50 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 shadow-2xl box-border"
          >
            {/* Back to Home */}
            <button
