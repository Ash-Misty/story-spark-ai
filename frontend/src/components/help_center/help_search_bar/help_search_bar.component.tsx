...
>>>>>>> origin/main
        ...
        {value && (
          <button
            ...
            onClick={() => onChange("")}
<<<<<<< HEAD
            className="absolute inset-y-0 right-0 pr-4 sm:pr-5 flex items-center text-slate-400 hover:text-slate-700 dark:text-slate-400 dark:hover:text-white transition-colors cursor-pointer"
=======
