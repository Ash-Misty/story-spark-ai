...
const createCollection = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await CollectionService.createCollection(req.body, token);
  sendResponse(res, {
...
const updateCollection = catchAsync(async (req: Request, res: Response) => {
  ...
  const token = await getToken(req);
  const result = await CollectionService.updateCollection(id, req.body, token);
  sendResponse(res, {
...
const getCollectionById = catchAsync(async (req: Request, res: Response) => {
  ...
  try {
    ...
    // unauthenticated visitor — fine for public collections
  }
